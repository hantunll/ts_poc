...
<template>
  <!-- <header class="header header--bg"> -->
    ...
    <!-- <div class="header__shape"> -->
      ...
      <img :src="require(`@/assets/img/navbar/tcbbar.jpg`)" width="1514" height="250"/>
    <!-- </div> -->
    <!-- <div class="container"> -->
      <!-- <div>
                 <img :src="require(`@/assets/img/navbar/tcbbar.jpg`)"  />
               </div> -->
          ...
          >
            <ul class="navbar__ul">
              ...
              <li class="navbar__item">
                ...
                <div class="top">
                  <div>
                <a> <img :src="require(`@/assets/img/navbar/tcb.jpg`)"  /></a>
                <b> <img :src="require(`@/assets/img/navbar/user.jpg`)" /></b>
              </div>
               </div>
              </li>
              <li class="navbar__item">
