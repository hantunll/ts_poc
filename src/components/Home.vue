...
export default {
    data() {
        return {
            sessoion: sessionStorage.getItem('account'),
        }
    },
    // mounted() {
...
/*page category*/
.header--bg {
    background: linear-gradient(90deg, #46b1ef 0%, #46b1ef 50%, #f4f4f4 50%, #f4f4f4 50%, #f4f4f4 100%);
    padding: 15px 0;
    margin-bottom: 60px;
}
